...
description: "Discover how Starlake OSS applies declarative programming to data engineering, enabling fast ingestion and transformation with YAML."
keywords:
    - starlake open source
...
<Head>
  <script type="application/ld+json">
    {JSON.stringify({
      ...
      "@type": "TechArticle",
      "headline": "Starlake OSS - Bringing Declarative Programming to Data Engineering and Analytics",
      "description": "Discover how Starlake OSS applies declarative programming to data engineering, enabling fast ingestion and transformation with YAML.",
