...
* **Transparent Transpilation:** Starlake automatically converts your written **Snowflake SQL** dialect into the **DuckDB dialect** when running locally. When you deploy, the original Snowflake SQL is used.
