...
description: "Partition BigQuery data by string columns using wildcard tables with Starlake's declarative YAML sharding configuration."
keywords:
    - bigquery wildcard tables
    - bigquery string partitioning
    - starlake sharding
...
<Head>
  <script type="application/ld+json">
    {JSON.stringify({
      ...
      "@type": "TechArticle",
      "headline": "How to Load and Transform into BigQuery Wildcard Tables",
      "description": "Partition BigQuery data by string columns using wildcard tables with Starlake's declarative YAML sharding configuration.",
