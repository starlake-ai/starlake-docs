...
authors:
  - sspaeti
image: /img/blog/beyond-basic-etl/hero.png
description: "Go beyond basic ETL with Starlake: configure SCD2, UPSERT, SQL transpilation, and auto-generated orchestration without custom code."
keywords:
    - enterprise ETL capabilities
    - starlake SCD2 UPSERT
    - sql transpilation multi-engine
...
<Head>
  <script type="application/ld+json">
    {JSON.stringify({
      ...
      "@type": "TechArticle",
      "headline": "Beyond Basic ETL: Enterprise Data Capabilities Without the Complexity",
      "description": "Go beyond basic ETL with Starlake: configure SCD2, UPSERT, SQL transpilation, and auto-generated orchestration without custom code.",
...
![hero](/img/blog/beyond-basic-etl/hero.png "Beyond Basic ETL: Enterprise Data Capabilities Without the Complexity")
...
![image](/img/blog/beyond-basic-etl/starlake-write-strategy.png "Example of how to load data and its configurations in Starlake GUI")
...
![image](/img/blog/beyond-basic-etl/starlake-acl.png "Starlake GUI to configure ACLs.")
