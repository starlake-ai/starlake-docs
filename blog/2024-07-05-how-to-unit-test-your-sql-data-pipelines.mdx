...
<Head>
  <script type="application/ld+json">
    {JSON.stringify({
      ...
      "@type": "TechArticle",
      "headline": "How to unit test your data pipelines",
      "description": "Learn how to unit test SQL data pipelines locally with DuckDB using Starlake, reducing costs and catching bugs before deployment.",
...
![Animated CI/CD pipeline flow for SQL data pipeline testing with Starlake and DuckDB]( /img/blog/how-to-unit-test-your-sql-data-pipelines/data-pipeline-cicd.gif)
