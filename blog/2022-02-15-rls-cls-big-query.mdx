...
description: "Implement row-level and column-level security in BigQuery using native features and Starlake's declarative YAML configuration."
keywords:
...
<Head>
  <script type="application/ld+json">
    {JSON.stringify({
      ...
      "@type": "TechArticle",
      "headline": "Column  and Row Level Security in BigQuery",
      "description": "Implement row-level and column-level security in BigQuery using native features and Starlake's declarative YAML configuration.",
