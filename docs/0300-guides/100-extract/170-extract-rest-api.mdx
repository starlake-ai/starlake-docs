...
| Command | Description |
|---------|-------------|
| [`extract-rest-schema`](/starflow/cli/extract-rest-schema) | Infer table schemas from API sample responses |
| [`extract-rest-data`](/starflow/cli/extract-rest-data) | Extract data to CSV files |
