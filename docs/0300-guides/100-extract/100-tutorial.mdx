...
- [Load Data into Your Warehouse](../load/tutorial) -- load extracted CSV files into BigQuery, Snowflake, Databricks or DuckDB
- [Configure Database Connections](../project-setup/connections) -- set up JDBC connections used by the extract command
- [Incremental Extraction](./incremental) -- extract only new rows using a partition column
- [Unit Testing Data Pipelines](../unit-tests/concepts) -- test your extract-load-transform pipeline locally
