...
- [Extract Tutorial](./tutorial) -- full walkthrough for setting up your first extraction
- [Load Data into Your Warehouse](../load/tutorial) -- load incrementally extracted files into your warehouse
- [Configure Database Connections](../project-setup/connections) -- set up the JDBC connection used for extraction
