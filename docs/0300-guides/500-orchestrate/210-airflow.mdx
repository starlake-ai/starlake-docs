...
This guide explains how to configure Starlake DAG generation for Apache Airflow, including BashOperator and Cloud Run factory classes, Jinja2 template customization, data-aware scheduling with Airflow Datasets, user-defined macros, and Terraform integration. It covers both inline dependency and data-aware scheduling strategies.

## How to configure Airflow DAGs for Starlake
...
For general DAG configuration concepts (references, properties, options), see the [Customizing DAG Generation](./200-customization.mdx) hub page.
