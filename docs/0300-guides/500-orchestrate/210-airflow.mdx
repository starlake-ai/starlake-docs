...
description: "Customize Starlake DAG generation for Apache Airflow, including concrete factory classes, templates, data-aware scheduling, user-defined macros, and Terraform integration."
keywords: [starlake, airflow, dag customization, cloud run, bash operator, data-aware scheduling, jinja2, orchestration]
