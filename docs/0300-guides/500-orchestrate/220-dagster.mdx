...
This guide covers Dagster-specific customization for Starlake DAG generation, including Shell and Cloud Run factory classes, Jinja2 templates for data loading and transformation, and the Multi Asset Sensor mechanism for dependency-driven execution. It details how Dagster asset materialization integrates with Starlake commands.

## How to configure Dagster assets for Starlake
