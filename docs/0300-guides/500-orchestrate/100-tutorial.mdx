...
![Starlake-generated Airflow DAGs list in the Airflow web UI](/img/orchestration/airflow/airflow-dags.png)

![Airflow DAG graph view showing Starlake transform task dependencies](/img/orchestration/airflow/transformWithDependencies2.png)

</TabItem>

<TabItem value="dagster" label="Dagster">

![Starlake-generated Dagster job graph with asset dependencies](/img/orchestration/dagster/dagster-dags.jpeg)

</TabItem>
<TabItem value="snowflake" label="Snowflake Tasks">

![Starlake-generated Snowflake Tasks DAG with task dependencies](/img/orchestration/snowflake/snowflake-dags.png)
...
- [Extract Data from Databases](../extract/tutorial) -- extract source data before loading and transforming
- [Load Data into Your Warehouse](../load/tutorial) -- load files that the generated DAGs will orchestrate
- [Transform Data with SQL](../transform/tutorial) -- write the SQL transforms that DAGs execute
- [Unit Testing Data Pipelines](../unit-tests/concepts) -- test your pipelines locally before deploying DAGs
