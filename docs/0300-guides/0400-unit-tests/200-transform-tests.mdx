...
description: "Write and run unit tests for Starlake SQL transforms locally using DuckDB transpilation, with expected output comparison and reports."
keywords: [starlake, transform test, unit test, duckdb, sql transpilation, data validation, test reports]
---
