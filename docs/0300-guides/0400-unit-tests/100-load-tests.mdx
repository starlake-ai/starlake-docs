    ...
    {JSON.stringify({
      ...
      "step": [
        ...
        },
        {
          "@type": "HowToStep",
          "name": "Run the test",
          "text": "Run 'starlake test --load' to execute all load tests, or 'starlake test --domain <domain> --table <table> --test <test-name>' for a specific test.",
          "position": 5
        }
      ]
    })}
    ...
    {JSON.stringify({
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Use the command starlake test --load. For a specific test: starlake test --domain <domain> --table <table> --test <test-name>."
          }
        },
        {
          "@type": "Question",
...
5. **Run the test** -- Execute `starlake test --load` or `starlake test --domain <domain> --table <table> --test <test-name>`.
