...
description: "Write and run unit tests for Starlake load tasks locally using DuckDB, with expected data comparison and detailed test reports."
keywords: [starlake, load test, unit test, duckdb, data loading, test reports, data validation]
---
