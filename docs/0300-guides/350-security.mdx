...
For excluding sensitive columns from ingestion entirely, see also the [`ignore` attribute](/starflow/guides/load/transform) as an alternative to column-level security.
