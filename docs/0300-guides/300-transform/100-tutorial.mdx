...
If you installed the [GraphViz tool](/setup/starlake-core-setup#prerequisites-4), you can produce the same graph in svg or png format using the following command:
