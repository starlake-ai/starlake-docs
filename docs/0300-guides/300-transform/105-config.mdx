---
title: "Customize Transform Configuration"
description: "Configure Starlake transform tasks with write strategies, partitioning, access control, and YAML settings for SQL and Python pipelines."
keywords: [starlake, transform configuration, write strategy, partitioning, yaml config, data pipeline]
---
