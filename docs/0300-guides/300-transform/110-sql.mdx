---
title: "SQL Transforms — Syntax and Patterns"
description: "Write SQL transforms in Starlake using SELECT statements with materialization strategies, Jinja templating, and column documentation."
keywords: [starlake, sql transforms, select statement, materialization, jinja templating, data pipeline]
---
