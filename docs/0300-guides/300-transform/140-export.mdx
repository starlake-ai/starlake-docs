---
title: "Export Transform Results"
description: "Export Starlake transform results to CSV, JSON, Parquet, Avro files or to external databases using sink configuration in YAML files."
keywords: [starlake, export data, csv export, parquet, data sink, transform output, data pipeline]
---
