...
description: "Run Python transforms in Starlake pipelines using DataFrame functions with YAML configuration, command-line options, and output tables."
keywords: [starlake, python transforms, dataframe, python pipeline, data transformation, spark]
---
