...
description: "Load JSON files with nested and repeated attributes into your data warehouse using Starlake. Supports JSON, JSON_FLAT and JSON_ARRAY formats."
keywords: [starlake, JSON, load, nested attributes, JSON_ARRAY, schema inference]
---
