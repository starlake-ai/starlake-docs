...
description: "Use Starlake autoload to detect file formats, infer schemas and load data into your warehouse with zero configuration required."
keywords: [starlake, autoload, zero-config, schema inference, data loading, file detection]
---
