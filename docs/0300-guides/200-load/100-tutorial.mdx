...
- [Extract Data from Databases](../extract/tutorial) -- extract source data as CSV files before loading
- [Transform Data with SQL](../transform/tutorial) -- build KPI tables from your loaded data
- [Write Strategies](./write-strategies) -- control how data is written to tables (APPEND, OVERWRITE, UPSERT, SCD2)
- [Unit Test Load Pipelines](../unit-tests/load-tests) -- validate loading logic locally with DuckDB
