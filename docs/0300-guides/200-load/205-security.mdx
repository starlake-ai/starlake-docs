...
For excluding sensitive columns from ingestion entirely, see also the [`ignore` attribute](/docs/guides/load/transform) as an alternative to column-level security.
