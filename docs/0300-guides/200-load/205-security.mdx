---
title: "Access Control — Row and Column Security"
description: "Define table-level, row-level and column-level access control in Starlake for BigQuery and Databricks using ACL and RLS policies."
keywords: [starlake, access control, ACL, row-level security, column-level security, BigQuery, Databricks]
---
