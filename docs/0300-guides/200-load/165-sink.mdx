---
title: "Clustering and Partitioning in Starlake — BigQuery, Databricks, Spark"
...
The `OVERWRITE_BY_PARTITION` [write strategy](/starflow/guides/load/write-strategies) depends on the partition configured in the sink section. Make sure to define `sink.partition` before using this strategy.
