...
The `OVERWRITE_BY_PARTITION` [write strategy](/guides/load/write-strategies) depends on the partition configured in the sink section. Make sure to define `sink.partition` before using this strategy.
