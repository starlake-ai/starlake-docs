...
description: "Configure clustering and partitioning in Starlake for BigQuery and Databricks to optimize query performance on large datasets."
keywords: [starlake, clustering, partitioning, BigQuery, Databricks, sink, query optimization]
---
