...
| Syntax | Description |
| --- | --- |
| `foreign_key: "<table>"` | Foreign key on the primary key of the specified table in the same domain. |
| `foreign_key: "<domain>.<table>"` | Foreign key on the primary key of the specified table in the specified domain. |
| `foreign_key: "<domain>.<table>.<column>"` | Foreign key on a specific column in the specified table and domain. |
| `foreign_key: "<table>.<column>"` | Foreign key on a specific column in the specified table in the same domain. |
