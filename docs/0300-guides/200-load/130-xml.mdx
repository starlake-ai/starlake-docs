...
description: "Load XML files with nested child nodes and node attributes into your data warehouse using Starlake. Configure row tags and attribute mapping."
keywords: [starlake, XML, load, nested attributes, node attributes, row tag, data warehouse]
---
