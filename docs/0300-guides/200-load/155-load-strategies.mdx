...
description: "Control file processing order with Starlake load strategies. Choose chronological or lexicographical ordering, or implement a custom strategy."
keywords: [starlake, load strategy, file ordering, IngestionTimeStrategy, IngestionNameStrategy, custom strategy]
---
