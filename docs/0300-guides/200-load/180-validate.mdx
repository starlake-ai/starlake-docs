---
title: "Type Validation in Starlake — Built-in and Custom Types with Regex"
...
:::tip
Type validation runs in Spark mode only. [Native load mode](/starflow/guides/load/native) skips this step entirely. Use post-load [expectations](/starflow/guides/load/expectations) as an alternative quality gate when running in native mode.
:::
