---
title: "Native Load Mode"
description: "Bypass Spark validation and load files directly into your data warehouse using Starlake native load mode at table, domain or project level."
keywords: [starlake, native load, bypass validation, direct load, Spark, performance]
---
