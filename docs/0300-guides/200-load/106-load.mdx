...
description: "Configure Starlake load manually for custom separators, non-standard folder layouts and per-environment incoming paths."
keywords: [starlake, manual load, load configuration, custom separator, incoming path]
---
