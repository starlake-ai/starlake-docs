...
description: "Load fixed-width positional files into your data warehouse with Starlake. Define column widths, infer schemas and validate field positions."
keywords: [starlake, fixed-width, positional, load, column width, schema inference]
---
