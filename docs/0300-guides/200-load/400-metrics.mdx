...
Use ingestion metrics to monitor data quality trends, detect anomalies and feed [post-load expectations](/docs/guides/load/expectations) with statistical baselines.
