...
description: "Compute continuous and discrete metrics on ingested data with Starlake. Track statistics like mean, variance, percentiles and category frequency."
keywords: [starlake, metrics, ingestion, continuous metrics, discrete metrics, data quality, statistics]
---
