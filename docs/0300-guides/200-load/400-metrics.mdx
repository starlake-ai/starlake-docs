    ...
    {JSON.stringify({
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Set the metricType property on the attribute in the table YAML file. Use continuous for numeric metrics or discrete for categorical metrics."
          }
        },
        {
          "@type": "Question",
  ...
  <script type="application/ld+json">
    {JSON.stringify({
      ...
      "step": [
        ...
        {
          "@type": "HowToStep",
          "name": "Set metricType: continuous on numeric attributes",
          "text": "Add metricType: continuous on attributes where you want statistical metrics (min, max, mean, variance, percentiles, etc.)."
        },
        {
          "@type": "HowToStep",
          "name": "Set metricType: discrete on categorical attributes",
          "text": "Add metricType: discrete on attributes where you want category frequency and count distinct metrics."
        },
        {
          "@type": "HowToStep",
          "name": "Run the load",
...
Use ingestion metrics to monitor data quality trends, detect anomalies and feed [post-load expectations](/starflow/guides/load/expectations) with statistical baselines.
