...
description: "Define data quality expectations in Starlake to validate loaded data. Write assertion queries that run against target tables after ingestion."
keywords: [starlake, expectations, data quality, assertions, validation, post-load checks]
---
