...
| Aspect | [Type validation](/guides/load/validate) | Expectations |
|---|---|---|
...
Use both for comprehensive data quality: type validation catches format errors at the record level, and expectations verify aggregate conditions on the loaded data. You can also base expectations on [ingestion metrics](/guides/load/metrics).
