...
description: "Set up Starlake with pre-configured Airflow or Dagster orchestration using Docker Compose for integrated data pipeline development."
keywords: [airflow setup, dagster setup, starlake orchestration, docker compose, data pipeline orchestration]
---
