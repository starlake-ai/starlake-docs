...
Kubernetes deployment is available via Helm charts. Contact the Starlake engineering team on [Discord](https://discord.gg/6tNa7yCNqw) for the latest Helm chart and deployment instructions.

## Deploy Starlake on AWS, GCP, or Azure

Cloud deployment via Terraform is available. Contact the Starlake engineering team on [Discord](https://discord.gg/6tNa7yCNqw) for the latest Terraform scripts targeting AWS, GCP, or Azure.
...
Kubernetes deployment is available. Contact the Starlake engineering team on [Discord](https://discord.gg/6tNa7yCNqw) to get the latest Helm chart.
