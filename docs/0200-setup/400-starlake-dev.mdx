    ...
    {JSON.stringify({
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Kubernetes deployment is available. Contact the Starlake engineering team on Discord to get the latest Helm chart."
          }
        },
        {
          "@type": "Question",
...
Kubernetes deployment is available via Helm charts. Contact the Starlake engineering team on [Discord](https://discord.gg/xHj9D6Rebp) for the latest Helm chart and deployment instructions.

## Deploy Starlake on AWS, GCP, or Azure

Cloud deployment via Terraform is available. Contact the Starlake engineering team on [Discord](https://discord.gg/xHj9D6Rebp) for the latest Terraform scripts targeting AWS, GCP, or Azure.
...
Kubernetes deployment is available. Contact the Starlake engineering team on [Discord](https://discord.gg/xHj9D6Rebp) to get the latest Helm chart.
