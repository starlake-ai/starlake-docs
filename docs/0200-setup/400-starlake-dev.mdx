...
:::tip
Starlake Dev is a Docker-based setup for Starlake with Airflow or Dagster pre-configured.

:::

Starlake Dev is ideal for developers and data engineers 
...
Starlake Dev may be installed on your own infrastructure, whether on your on-premises or in the cloud.
