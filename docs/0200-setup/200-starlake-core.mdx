...
- [Create your first project](/starflow/guides/project-setup/starlake-project-setup)
- [Load your first dataset](/starflow/guides/load/tutorial)
- [Transform your data](/starflow/guides/transform/tutorial)
