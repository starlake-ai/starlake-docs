...
On Windows the requested version must be one of the recent releases the script lists; for an older release, install any listed version and then run `starlake upgrade --version X.Y.Z`.
