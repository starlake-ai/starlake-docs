    ...
    {JSON.stringify({
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Run 'starlake upgrade' to fetch the latest versions from GitHub Releases. The command lets you choose which version to install and automatically updates the configuration and downloads the new JAR files."
          }
        },
        {
          "@type": "Question",
...
1. **Version selection** -- Retrieves the most recent release versions from GitHub Releases. You choose which one to install.
...
Run `starlake upgrade` to fetch the latest versions from GitHub Releases. The command lets you choose which version to install and automatically updates the configuration and downloads the new JAR files.
